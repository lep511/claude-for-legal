...
const FilePreview: React.FC<FilePreviewProps> = ({
  ...
  return (
    <div className="relative inline-flex flex-col items-center gap-1" title={file.fileName}>
      <div className="relative rounded-lg border bg-card text-card-foreground shadow-sm w-16 h-16">
        {isImage ? (
