...
|---|---|---|
| Demand letter received | the demand-received workflow ([path]) | triage.md + optional response draft |
| Subpoena served | the subpoena-triage workflow ([path]) | triage.md + objections memo |
