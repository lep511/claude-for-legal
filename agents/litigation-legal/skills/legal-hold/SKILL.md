...
2. Otherwise: load `claude-for-legal/agents/litigation-legal/matters/[slug]/matter.md` + log row.
3. Load `claude-for-legal/agents/litigation-legal/CLAUDE.md` → privilege markings, hold template pointer, escalation norms.
...
- `claude-for-legal/agents/litigation-legal/matters/_log.yaml` — log row (legal_hold fields + status)
- `claude-for-legal/agents/litigation-legal/matters/[slug]/matter.md` — matter context (counterparty, facts, key custodians from internal_owners)
- `claude-for-legal/agents/litigation-legal/CLAUDE.md` — house style for litigation hold template pointer, privilege marking, escalation norms
...
**Before issuing the hold to custodians (the consequential act):** Read `## Who's using this` in `claude-for-legal/agents/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Draft the notice** to each custodian, using the house template in `claude-for-legal/agents/litigation-legal/CLAUDE.md` if one is configured; otherwise the default template below.
...
DATE: [effective date]
TO: [custodian name]
FROM: [signer — per `claude-for-legal/agents/litigation-legal/CLAUDE.md` default]
...
**Writes:**
- `claude-for-legal/agents/litigation-legal/matters/[slug]/legal-hold-v1.docx` via the `docx` skill
- Appends to `claude-for-legal/agents/litigation-legal/matters/[slug]/history.md`:
  ```
...
**Writes:**
- `claude-for-legal/agents/litigation-legal/matters/[slug]/legal-hold-v[N].docx` (next version number)
- `history.md` entry
...
**Before releasing the hold (the consequential act — preservation obligations resume normal retention):** Read `## Who's using this` in `claude-for-legal/agents/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Writes:**
- `claude-for-legal/agents/litigation-legal/matters/[slug]/legal-hold-release.docx`
- `history.md` entry
