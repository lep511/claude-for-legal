...
1. Load `claude-for-legal/agents/litigation-legal/CLAUDE.md` → case theory, key facts.
...
`claude-for-legal/agents/litigation-legal/CLAUDE.md` → case theory (theory, pivot fact, key facts for/against), eDiscovery platform.
...
- Facts from `claude-for-legal/agents/litigation-legal/CLAUDE.md` → key facts for us, that this witness can establish
