...
3. If grand jury → stop, escalate per `claude-for-legal/agents/litigation-legal/CLAUDE.md`. Otherwise continue.
4. Load `claude-for-legal/agents/litigation-legal/matters/_log.yaml` for cross-check. Load `claude-for-legal/agents/litigation-legal/CLAUDE.md` → landscape, privilege conventions, escalation norms.
...
7. Write `claude-for-legal/agents/litigation-legal/inbound/[slug]/triage.md`. Copy or link subpoena to `claude-for-legal/agents/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `claude-for-legal/agents/litigation-legal/matters/_log.yaml` — for related matter lookup and legal hold status
- `claude-for-legal/agents/litigation-legal/CLAUDE.md` → landscape (regulators we deal with), house privilege conventions, escalation norms
...
- Privilege log will be required — flag the format per `claude-for-legal/agents/litigation-legal/CLAUDE.md`
...
**Privilege log format required:** [per `claude-for-legal/agents/litigation-legal/CLAUDE.md`]
...
**Before responding to the subpoena (serving objections, producing documents, appearing for deposition, or filing a motion to quash — any substantive response to the issuing party or court):** Read `## Who's using this` in `claude-for-legal/agents/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
- If classified as **grand jury subpoena** → stop, flag for escalation per `claude-for-legal/agents/litigation-legal/CLAUDE.md`, do not proceed with standard triage.
