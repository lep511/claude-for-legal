...
description: >
  ...
  Runs weekly by default. Posts to the channel named in `claude-for-legal/agents/commercial-legal/CLAUDE.md` → House style
...
1. Read `claude-for-legal/agents/commercial-legal/CLAUDE.md` to get the alert destination (Slack channel or email list).
