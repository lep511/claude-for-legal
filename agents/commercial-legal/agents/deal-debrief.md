...
The output feeds `claude-for-legal/agents/commercial-legal/deviation-log.yaml`. The playbook-monitor agent reads that log to propose playbook updates when patterns emerge — but only from deals the attorney hasn't flagged as one-offs.
...
Read `claude-for-legal/agents/commercial-legal/CLAUDE.md` in full. Extract:
...
Using the repository location from `claude-for-legal/agents/commercial-legal/CLAUDE.md`:
...
2. Identify the applicable playbook section(s) from `claude-for-legal/agents/commercial-legal/CLAUDE.md`.
...
```
[#] [Deal] — [Clause]
Playbook position: [standard position from `claude-for-legal/agents/commercial-legal/CLAUDE.md`]
...
Append a structured entry to `claude-for-legal/agents/commercial-legal/deviation-log.yaml` for each agreement processed.
...
Logged to: claude-for-legal/agents/commercial-legal/deviation-log.yaml
