...
1. Read `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` → outputs folder path, AI policy document, last sweep date.
...
6. Flag any use cases in outputs not yet added to the `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` registry.
7. Present results to the human. Only after acknowledgment, update `Last policy sweep` and `gaps_found` in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`.

**Direct query mode** (with description argument):
1. Read `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` → current policy commitments, use case registry, actual policy document.
...
→ **AI policy document**. The commitments in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` are a summary; the actual
...
**Do not update `Last policy sweep` or `gaps_found` automatically.** After the sweep results are presented, wait for the human to acknowledge them ("sweep acknowledged," "results reviewed," or equivalent). Only then update `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`:
...
- Extract: vendor added, data use terms agreed to, any AI-specific provisions
  accepted that differ from standard positions in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`
...
[Any use cases approved since the last sweep that aren't yet in the `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`
...
[If this use case isn't in the registry: "Add to `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` → Use case registry:"]
```
