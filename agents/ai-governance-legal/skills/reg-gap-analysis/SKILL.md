...
1. Read `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`. Confirm regulatory footprint and use case registry are populated.
...
4. Extract requirements. Diff against current state in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`.
...
(per `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` — use case registry, vendor positions, impact assessment practices,
...
**We currently:** [what `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` / AI policy / use case registry / assessment
practice shows]
