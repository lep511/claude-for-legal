...
description: >
  ...
  assessment in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`.
...
1. Read `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`. Confirm impact assessment house style is populated.
...
6. Policy diff against `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` AI policy commitments.
...
- Is the use case in the elevated or high governance tier per `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`?
...
Before intake, determine which track to run. The tier definitions and the fast-track criteria come from `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` (`## Use case registry` and `## Governance tiers`), not from any hardcoded regime-specific framework.
...
**Fast track vs. full assessment:** `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` defines what qualifies for abbreviated treatment. If `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` doesn't define fast-track criteria, default to full assessment and ask the user what criteria they want captured for next time.
...
For each regime in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` → `## Regulatory footprint` that applies to this system — **plus any regime surfaced by the re-derivation above** — research the currently operative risk classification framework and determine where the system lands.
...
**Use the seed structure from `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`.** If none was captured, use this default:
...
|---|---|---|
| [commitment from `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` AI policy section] | 🟢 / 🟡 / 🟠 / 🔴 | |
...
**Before certifying the AIA (the Sign-off step, marking Status: APPROVED):** Read `## Who's using this` in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
Every assessment should cross-check against the AI policy commitments in `claude-for-legal/agents/ai-governance-legal/CLAUDE.md`.
Common drift:
