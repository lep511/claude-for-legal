...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | Writes `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` from interview + seed docs |
...
Your configuration is stored at `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` and survives plugin updates.
...
- The `## Company profile` section is the first block of `claude-for-legal/agents/ai-governance-legal/CLAUDE.md` by convention. If
