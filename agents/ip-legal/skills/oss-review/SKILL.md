...
Prepend the work-product header from `claude-for-legal/agents/ip-legal/CLAUDE.md` → `## Outputs` (differs by user role — see `## Who's using this`).
