...
- **Policy owner missing:** still produce the redraft. Note in the reviewer note: "No policy owner is set for [policy] in `## Policy library`. Assign one with the Settings page to reconfigure so the approval path is routable."
