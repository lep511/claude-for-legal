...
1. Load `claude-for-legal/agents/regulatory-legal/CLAUDE.md` → watchlist, materiality threshold, feed config.
...
`claude-for-legal/agents/regulatory-legal/CLAUDE.md` → watchlist, materiality threshold, feed configuration, digest output path (if set).
...
- **Direct regulator RSS** — fetch and parse any RSS URLs in claude-for-legal/agents/regulatory-legal/CLAUDE.md feed
...
Each item gets a materiality tier per `claude-for-legal/agents/regulatory-legal/CLAUDE.md`:
...
- If comment tracking is enabled in claude-for-legal/agents/regulatory-legal/CLAUDE.md: append to `claude-for-legal/agents/regulatory-legal/comment-tracker.yaml`
  with status "undecided" and the default comment decision owner from claude-for-legal/agents/regulatory-legal/CLAUDE.md
...
1. Look for `Digest output path` in `claude-for-legal/agents/regulatory-legal/CLAUDE.md`. If set, write there. Default if unset: `~/regulatory-legal-digests/reg-digest-YYYY-MM-DD.md`.
...
- Change the materiality threshold. If the filter is wrong, edit claude-for-legal/agents/regulatory-legal/CLAUDE.md.
