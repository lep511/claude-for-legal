...
4. Write `claude-for-legal/agents/regulatory-legal/CLAUDE.md` (creating parent directories as needed) with watchlist + materiality threshold.
...
Read `claude-for-legal/agents/regulatory-legal/CLAUDE.md`:
...
If a CLAUDE.md exists at the old cache path `claude-for-legal/plugins/cache/claude-for-legal/regulatory-legal/*/CLAUDE.md` but not at the config path, copy it forward.
