...
> jurisdiction in `claude-for-legal/agents/employment-legal/CLAUDE.md`, identify the currently operative leave statutes,
...
Read `claude-for-legal/agents/employment-legal/CLAUDE.md`. Extract:
...
preference in `claude-for-legal/agents/employment-legal/CLAUDE.md`):
...
(3) Escalation per `claude-for-legal/agents/employment-legal/CLAUDE.md` before proceeding.
...
After running, update `claude-for-legal/agents/employment-legal/leave-register.yaml` with recalculated fields
...
`claude-for-legal/agents/employment-legal/leave-register.yaml`:
