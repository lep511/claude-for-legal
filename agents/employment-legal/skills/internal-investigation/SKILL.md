...
Prepend the work-product header from `claude-for-legal/agents/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `claude-for-legal/agents/employment-legal/CLAUDE.md` → escalation table, any investigation protocols noted.
...
`claude-for-legal/agents/employment-legal/investigation-[matter-slug]/log.yaml`:
...
`claude-for-legal/agents/employment-legal/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`claude-for-legal/agents/employment-legal/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`claude-for-legal/agents/employment-legal/investigation-[slug]/sources-checklist.yaml`.
...
If multiple investigation folders exist in `claude-for-legal/agents/employment-legal/`, ask which matter this
...
Write the draft to `claude-for-legal/agents/employment-legal/investigation-[slug]/memo.md`.
