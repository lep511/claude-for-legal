...
Adds a new leave entry to `claude-for-legal/agents/employment-legal/leave-register.yaml` with the minimum
...
1. Read `claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `claude-for-legal/agents/employment-legal/CLAUDE.md`, look up the applicable leave
...
5. Write a new entry to `claude-for-legal/agents/employment-legal/leave-register.yaml` using the leave register
