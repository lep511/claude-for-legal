...
5. If a populated CLAUDE.md (no `[PLACEHOLDER]` markers) exists at `claude-for-legal/plugins/cache/claude-for-legal/employment-legal/*/CLAUDE.md` but not at the config path, copy it to the config path and tell the user what was migrated.
6. Write `claude-for-legal/agents/employment-legal/CLAUDE.md`, creating parent directories as needed.
...
Read `claude-for-legal/agents/employment-legal/CLAUDE.md`:
