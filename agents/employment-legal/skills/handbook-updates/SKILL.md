...
`claude-for-legal/agents/employment-legal/CLAUDE.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `claude-for-legal/agents/employment-legal/CLAUDE.md`:
