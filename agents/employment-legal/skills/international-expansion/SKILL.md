...
Read `claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `claude-for-legal/agents/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** claude-for-legal/agents/employment-legal/expansion-[slug].yaml
