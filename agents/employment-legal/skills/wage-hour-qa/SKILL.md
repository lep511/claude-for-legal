...
1. Load `claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdictional footprint.
...
`claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdictional footprint. If the question doesn't specify a
