...
1. Load `claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table.
...
Read `claude-for-legal/agents/employment-legal/CLAUDE.md` → jurisdictional footprint, any classification history or
...
If `claude-for-legal/agents/employment-legal/CLAUDE.md` records the company's house classification policy, apply it
...
Escalate per `claude-for-legal/agents/employment-legal/CLAUDE.md` if any of the following, or any team-specific
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in `claude-for-legal/agents/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
