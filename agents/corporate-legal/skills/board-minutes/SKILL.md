...
- `claude-for-legal/agents/corporate-legal/CLAUDE.md` → `## Board & Secretary` section:
...
- If `claude-for-legal/agents/corporate-legal/CLAUDE.md` has no minutes format: run cold-start first. Do not proceed with a generic format.
...
**Directors present:**
- Pull from board composition in `claude-for-legal/agents/corporate-legal/CLAUDE.md` as the starting point
...
Use the house format from `claude-for-legal/agents/corporate-legal/CLAUDE.md`. Do not default to a generic format. The seed minutes are the template — replicate the structure, the header, the resolution language, the level of discussion detail.
...
**Previous minutes:**
Standard language: approval of minutes from prior meeting. Pull date of prior meeting from `claude-for-legal/agents/corporate-legal/CLAUDE.md` board calendar if available, otherwise leave as [DATE OF PRIOR MEETING].
...
RESOLVED, that [resolution text in house language from `claude-for-legal/agents/corporate-legal/CLAUDE.md`].
```
...
**Before adopting minutes as final:** Read `## Who's using this` in `claude-for-legal/agents/corporate-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
