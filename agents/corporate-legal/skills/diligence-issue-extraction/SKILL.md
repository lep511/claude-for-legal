...
1. Load `claude-for-legal/agents/corporate-legal/CLAUDE.md` + `claude-for-legal/agents/corporate-legal/deals/[code]/deal-context.md`.
...
The VDR has 2,000 documents. Somewhere in there are the 30 that matter for the deal. This skill reads documents against the diligence categories and materiality thresholds from `claude-for-legal/agents/corporate-legal/CLAUDE.md`, extracts issues, and writes them in house memo format.

## Load context

- `claude-for-legal/agents/corporate-legal/CLAUDE.md` → Diligence structure (categories, materiality thresholds)
- `claude-for-legal/agents/corporate-legal/CLAUDE.md` → Issues memo format (how findings are stated)
- `claude-for-legal/agents/corporate-legal/deals/[code]/deal-context.md` → deal-specific thresholds, VDR location
...
Per `claude-for-legal/agents/corporate-legal/CLAUDE.md` / deal-context thresholds. Don't review everything if the threshold says contracts >$X.
...
Per the finding template in `claude-for-legal/agents/corporate-legal/CLAUDE.md`. If the seed memo used this:
...
- **To ai-tool-handoff:** If Luminance/Kira is in use per `claude-for-legal/agents/corporate-legal/CLAUDE.md`, hand bulk contract review there. This skill handles the nuanced documents (side letters, amendments, anything the AI tool struggles with).
...
- It doesn't replace bulk AI review. For high-volume clause extraction, hand off to Luminance/Kira per `claude-for-legal/agents/corporate-legal/CLAUDE.md`. This skill is for the judgment layer.
