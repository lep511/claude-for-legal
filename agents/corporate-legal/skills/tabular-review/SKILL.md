...
1. Load `claude-for-legal/agents/corporate-legal/CLAUDE.md` → diligence structure, thresholds, house format.
...
- `claude-for-legal/agents/corporate-legal/CLAUDE.md` → diligence structure, materiality thresholds, house format preferences
- `claude-for-legal/agents/corporate-legal/deals/[code]/deal-context.md` if working a specific deal
