...
5. Read/write `claude-for-legal/agents/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `claude-for-legal/agents/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `claude-for-legal/agents/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `claude-for-legal/agents/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `claude-for-legal/agents/corporate-legal/deals/[code]/closing-checklist.yaml`
